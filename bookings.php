  ...
  <div class="container">
    <div class="row">
      ...
      while ($data = mysqli_fetch_assoc($result)) {
        ...
        $total_pay_chia_2 = $total_pay / 2; // Chia giá trị cho 2
            ...
            <div class='col-md-4 px-4 mb-4'>
              <div class='bg-white p-3 rounded shadow-sm'>
                ...
                <p>
                  ...
                  <b>Số tiền cọc: </b> $total_pay_chia_2 vnđ;<br>
                  <b>ID Dơn: </b> $data[order_id] <br>
                  <b>Ngày Đặt: </b> $date
                </p>
                <p>
                  <span class='badge $trangthai'>$data[booking_status]</span>
                </p>
                $btn
              </div>
            </div>
